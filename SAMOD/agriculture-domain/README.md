...
- **Section**: A section of land.
- **Crop**: A crop
- **CropType**: The type of crop [Corn, Wheat].
- **hasDimensions**: A property to indicate what dimension a Farm or a Section has.
- **isMoistured**: A property to indicate if soil is moistured.
- **isCropped**: A property to indicate if a soil has been cropped.
